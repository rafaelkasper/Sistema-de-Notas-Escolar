...
<html>
    ...
    <body class="bg-light">
        <div class="container">
            ...
            <br>
            <br>
            <h3><b>CADASTRAR HORAS</b></h3> 
            <form method="POST" action="equipe_proc_cadastrar_horas.php">
                <br>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <p style="font-size: 16px; font-family: Trebuchet MS, sans-serif;">PROFESSOR:</p>

                        <?php
                        $consul = $con->query("SELECT * FROM professores ORDER BY nome");
                        ?>
                        <select class="form-control form-control-sm"  id="professores_id" style="width: 150px;" name="professores_id" required>

            ...
            <div class="container">
                <form method="POST" action="">
                    ...
                    <p>
                        ...
                        <input type="hidden" name="equipe_id" value="<?php $equipe_id ?>">
                    ...
                    <tbody>
                        <tr>
                            ...
                            if ($SendPesqUser) {
                                ...
                                $resultado_usuario = $con->query("SELECT * FROM equipe_diretiva WHERE id = '$equipe_id' ORDER BY nome_equipe");
                                while ($rows = $resultado_usuario->fetch_assoc()) { {
                                        echo "<td>" . $rows['nome_equipe'] . "</td>";
                                        echo "<td>" . $rows['login'] . "</td>";
                                        echo "<td>" . $rows['senha'] . "</td>";
                                        echo "<td>" . $rows['email'] . "</td>";
                                        echo "<td>" . $rows['telefone'] . "</td>";
                                        echo "<td>";
                                        echo "<a class='btn btn-warning' href='equipe_function_alterar_equipe.php?id=" . $rows['id'] . "'>Editar</a>&nbsp;&nbsp;&nbsp;" . "</td>";

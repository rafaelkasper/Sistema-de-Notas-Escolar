<?php
//FORM PARA PODER VISUALIZAR A FORMATIVA DAS TURMAS
...
<html>
    ...
    <body class="bg-light">
        <div class="container">
            ...
            <br>
            <br>
            <h3><b><i class="fas fa-graduation-cap"></i>   CONSULTAR FORMATIVA</b></h3> 

            <form method="POST" action="equipe_proc_consultar_formativa.php">
                <br>
                ...
                <input type="hidden" name="disciplinas[]" value="<?php echo $disciplinas_id; ?>">

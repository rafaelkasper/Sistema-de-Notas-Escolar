<?php
//FORM PARA PODER VISUALIZAR AS MÉDIAS DAS TURMAS
...
<html>
    ...
    <body class="bg-light">
        <div class="container">
            ...
            <br>
            <br>
            <h3><b><i class="far fa-bookmark"></i>  CONSULTAR MÉDIA</b></h3> 

            <form method="POST" action="equipe_proc_consultar_media.php">
                <br>

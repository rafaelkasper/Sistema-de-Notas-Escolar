    ...
    <body class="bg-light">
        ...
        <div class="container">
            ...
            if (isset($_SESSION['sucesso'])) {
                echo "<br>";
                echo "<br>";
                echo "<div class='alert alert-success alert-dismissible fade show' role='alert'> FUNCIONÁRIO(A) ALTERADO(A) COM SUCESSO!<button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button></div>";
                unset($_SESSION['sucesso']);
            }

            if (isset($_SESSION['erro'])) {
                echo "<div class='alert alert-danger alert-dismissible fade show' role='alert'> ERRO AO ALTERAR FUNCIONÁRIO(A)!<button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button></div>";
            ...
            <h3><i class="fas fa-id-card-alt"></i>      ALTERAR FUNCIONÁRIOS</h3> 
            <div class="container">
                    ...
                    <tbody>
                        <tr>
                            ...
                            if ($SendPesqUser) {
                                ...
                                $resultado_usuario = $con->query("SELECT * FROM funcionarios WHERE nome LIKE '%$nome%' ORDER BY nome");
                                while ($rows = $resultado_usuario->fetch_assoc()) { {
                                        ...
                                        echo "<a class='btn btn-warning' style='text-align: center;' href='ads_function_alterar_func.php?id=" . $rows['id'] . "'>Editar</a>&nbsp;&nbsp;&nbsp;";
                                        echo "<a class='btn btn-danger' style='text-align: center;' href='ads_function_apagar_func.php?id=" . $rows['id'] . "'data-confirm='Tem certeza de que deseja excluir o item selecionado?'>Apagar</a><br>"
                                        . "</td>";
                                        echo "</tr>";
                                    }
                                }

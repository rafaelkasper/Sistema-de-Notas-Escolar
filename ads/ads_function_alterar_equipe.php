<?php
//EDITA AS INFORMAÇÕES SOBRE A EQUIPE DIRETIVA
include '../functions/valida_sessao_ads.php';
include '../functions/conecta_banco.php';
$id = filter_input(INPUT_GET, 'id', FILTER_SANITIZE_NUMBER_INT);
$resultado_usuario = $con->query("SELECT * FROM equipe_diretiva WHERE id = '$id'");
...
<html>
    ...
    <body class="bg-light">
        ...
        <div class="container">
            ...
            <h3>ALTERAR EQUIPE DIRETIVA</h3>
            <form action="ads_function_salvar_alterar_equipe.php" method="POST">

                <div class="form-group">
                    <label for="nome_equipe">NOME</label>
                    <input type="text" class="form-control" id="nome_equipe" name="nome_equipe" value="<?php echo $row_usuario["nome_equipe"]; ?>">
                </div>

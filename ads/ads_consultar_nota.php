<?php
//CONSULTA AS NOTAS DE ACORDO COM TURMA E DISCIPLINA
...
<html>
    ...
    <body class="bg-light">
        <div class="container">
            ...
            <form method="POST"action="ads_proc_consulta_notas.php">
                <br>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <select class="custom-select form-control" style="width: 150px;" name="disciplina_id" id="disciplina_id">
                            <option value="">SELECIONE</option>
                        </select>

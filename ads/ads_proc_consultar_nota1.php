<?php
//PÁGINA PARA CONFERIR AS NOTAS DIGITADAS E SALVAR NO BD AS MÉDIAS
    ...
    <body class="bg-light">
     ...
     @$SendPesqUser = $_POST['SendPesqUser'];
        ...
        ?>
            ...
            <form  method="POST" action="ads_salvar_nota1.php">
...
while ($rows = $result->fetch_array()) {
    ?>
                        <tr class="p-0 m-0">
                            <td class="w-25 p-1 m-0"><input type="text" class="p-0 m-0 border-0 bg-light" style="width: 100%;" name="nome_aluno[]" readonly value="<?php echo $rows['nome_aluno']; ?>"></td>
...
?>
                    ...
                    &nbsp; &nbsp; 
                    <input  type="submit" style="color:white; font-weight: bold;" class="btn btn-success" value="SALVAR MÉDIAS">
                    </form>
                    <br>
                    </div>

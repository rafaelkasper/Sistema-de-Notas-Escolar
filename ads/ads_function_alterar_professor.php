<?php
//EDITA AS INFORMAÇÕES SOBRE OS PROFESSORES
include '../functions/valida_sessao_ads.php';
include '../functions/conecta_banco.php';
$id = filter_input(INPUT_GET, 'id', FILTER_SANITIZE_NUMBER_INT);
$resultado_usuario = $con->query("SELECT * FROM professores WHERE id = '$id'");
...
<html>
    ...
    <body class="bg-light">
        ...
        <div class="container">
            ...
            <form action="ads_function_salvar_alterar_professor.php" method="POST">

                <div class="form-group">
                    <label for="nome_professor">NOME DO(A) PROFESSOR(A)</label>
                    <input type="text" class="form-control" id="nome_professor" name="nome" value="<?php echo $row_usuario["nome"]; ?>">
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-2 row d-flex justify-content-center">
                        <br>

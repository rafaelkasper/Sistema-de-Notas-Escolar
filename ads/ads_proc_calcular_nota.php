<?php
//CALCULA A MÉDIA DAS NOTAS DIGITADAS E RETORNA PARA A PÁGINA DE DIGITAÇÃO DAS NOTAS
                                            ...
                                            foreach (array($nota10) as $nota10) {
                                                foreach (array($turmas_id) as $turmas_id) {
                                                    foreach (array($aluno_id) as $aluno_id) {
                                                        foreach (array($disciplina_id) as $disciplina_id) {
                                                            foreach (array($media) as $media) {
                                                                foreach (array($faltas) as $faltas) {
                                                                    for ($i = 0; $i < count($nome_aluno); $i++) {
                                                                        ...
                                                                        header("Location: ads_proc_consulta_notas.php");
                                                                    }
                                                                }
                                                            }
                                                        }

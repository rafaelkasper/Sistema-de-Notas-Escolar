<?php
//EDITA AS INFORMAÇÕES SOBRE ALUNOS
include '../functions/valida_sessao_ads.php';
include '../functions/conecta_banco.php';
$id = filter_input(INPUT_GET, 'id', FILTER_SANITIZE_NUMBER_INT);
$resultado_usuario = $con->query("SELECT * FROM alunos join status on alunos.status = status.id WHERE alunos.id = '$id'");
...
<html>
    ...
    <body class="bg-light">
        ...
        <div class="container">
            ...
            <h3>ALTERAR ALUNO</h3>
            <form action="ads_function_salvar_alterar_aluno.php" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="turma" name="turma" value="<?php echo $row_usuario["turma"]; ?>">
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="chamada" name="chamada" value="<?php echo $row_usuario["chamada"]; ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="turma">SITUAÇÃO</label>

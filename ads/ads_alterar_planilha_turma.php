...
//ALTERA A PLANILHA DE NOTAS DA TURMA CASO HAJA ALGUMA MUDANÇA EM RELAÇÃO ÀS DISCIPLINAS OU PROFESSORES
?>
...
<html>
    ...
    <body class="bg-light">
        ...
        <div class="container">
                    ...
                    <tbody>
                        <tr>
                            ...
                            if ($SendPesqUser) {
                                ...
                                $resultado_usuario = $con->query("SELECT alunos.nome_aluno, notas.id, notas.aluno_id, notas.turmas_id, notas.disciplina_id, notas.professores_id, notas.ano_letivo_id, disciplinas.nome_disciplina FROM alunos join notas on alunos.id = notas.aluno_id join turmas on notas.turmas_id = turmas.id join disciplinas on notas.disciplina_id=disciplinas.id where notas.turmas_id = $turma AND notas.professores_id = $professores_id AND notas.disciplina_id = $disciplina_id AND notas.ano_letivo_id = $ano_letivo ORDER BY alunos.nome_aluno");
                                $rows = $resultado_usuario->fetch_array();
                                // echo "<td>" . $rows['nome_aluno'] . "</td>";
                                echo "<td>" . $rows['nome_disciplina'] . "</td>";
                                ...
                                echo "<a class='btn btn-warning' href='ads_function_alterar_planilha_turma.php?id=" . $rows['professores_id'] . "'>Editar</a>&nbsp;&nbsp;&nbsp;";
                                ...
                                . "</td>";
                                echo "</tr>";
                                $_SESSION['turma'] = $rows['turmas_id'];
                                $_SESSION['disciplina_antiga'] = $rows['disciplina_id'];
                            }
                            ?>
                    </tbody>
                </table>
            ...
            <script type="text/javascript">
                //SCRIPT PARA CARREGAR A DISCIPLINA CONFORME O PROFESSOR
                $(function () {

<?php
//REALIZA A CONSULTA DAS MÉDIAS E FALTAS DAS DISCIPLINAS
...
<html>
    ...
    <body class="bg-light">
        <div class="container">
            ...
            <br>
            <br>
            <h3><i class="far fa-bookmark"></i>     <b>CONSULTAR MÉDIA</b></h3> 

            <form method="POST"action="ads_proc_consultar_media.php">
                <br>

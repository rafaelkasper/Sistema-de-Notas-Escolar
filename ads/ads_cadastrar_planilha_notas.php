                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check form-check-inline">
                            <label class="form-check-label" for="turma_id">TURMA:&nbsp;&nbsp;&nbsp;</label>

                            <?php while ($class = $consulta->fetch_array()) { ?>
                                <input type="checkbox" id="turma_id" name="turma_id[]" class="form-check-input" value="<?php echo $class['id']; ?>"><?php echo $class['nome_turma']; ?>&nbsp;&nbsp;&nbsp;</input>
                            <?php } ?>
                        </div>
                    </div>
                </div>

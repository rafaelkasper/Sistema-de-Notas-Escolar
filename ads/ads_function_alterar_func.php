<?php
//EDITA AS INFORMAÇÕES SOBRE OS FUNCIONÁRIOS
include '../functions/valida_sessao_ads.php';
include '../functions/conecta_banco.php';
$id = filter_input(INPUT_GET, 'id', FILTER_SANITIZE_NUMBER_INT);
$resultado_usuario = $con->query("SELECT * FROM funcionarios WHERE id = '$id'");
...
<html>
    ...
    <body class="bg-light">
        ...
        <div class="container">
            ...
            <form action="ads_function_salvar_alterar_func.php" method="POST">

                <div class="form-group">
                    <label for="nome">NOME</label>
                    <input type="text" class="form-control" id="nome" name="nome" value="<?php echo $row_usuario["nome"]; ?>">
                </div>

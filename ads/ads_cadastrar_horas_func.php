...
<html>
    ...
    <body class="bg-light">
        <div class="container">
            ...
            <br>
            <br>
            <h3><i class="fas fa-business-time"></i>     <b>CADASTRAR HORAS FUNCIONÁRIOS(AS)</b></h3> 
            <form method="POST" action="ads_proc_cadastrar_horas_func.php">
                <br>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        ?>
                        <select class="custom-select form-control form-control-sm"  id="func_id" style="width: 150px;" name="func_id" required>

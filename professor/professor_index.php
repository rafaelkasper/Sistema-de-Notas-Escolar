...
$id = $row ['id'];
$recado = $con->query("SELECT mensagem FROM mensagens WHERE professor_id = $professores_id");
    ...
    <body class="bg-light">
        ...
        <div class="container">
            ...
            if (isset($rec[0])) {
                ...
                $deletar = $con->query("DELETE FROM mensagens WHERE professor_id = $professores_id");
            }
            ?>
            <br>
            <br>

<?php
//EXIBE AS NOTAS SEM POSSIBILIDADE DE EDIÇÃO
     ...
     <table class="table table-bordered table-hover p-0 m-0">
                ...
                while ($rows = $result->fetch_array()) {
                    ...
                    <tr class="p-0 m-0">
                        ...
                        <td class="p-1 m-0 align-middle nota" style="text-align:center;"><?php echo $rows['nota1']; ?></td>
                        <td class="p-1 m-0 align-middle nota" style="text-align:center;"><?php echo $rows['nota2']; ?></td>
                        <td class="p-1 m-0 align-middle nota" style="text-align:center;"><?php echo $rows['nota3']; ?></td>
                        <td class="p-1 m-0 align-middle nota" style="text-align:center;"><?php echo $rows['nota4']; ?></td>
                        <td class="p-1 m-0 align-middle nota" style="text-align:center;"><?php echo $rows['nota5']; ?></td>
                        <td class="p-1 m-0 align-middle nota" style="text-align:center;"><?php echo $rows['nota6']; ?></td>
                        <td class="p-1 m-0 align-middle nota" style="text-align:center;"><?php echo $rows['nota7']; ?></td>
                        <td class="p-1 m-0 align-middle nota" style="text-align:center;"><?php echo $rows['nota8']; ?></td>
                        <td class="p-1 m-0 align-middle nota" style="text-align:center;"><?php echo $rows['nota9']; ?></td>
                        <td class="p-1 m-0 align-middle nota" style="text-align:center;"><?php echo $rows['nota10']; ?></td>
                        <?php
                        $colunas = 10;
                        if (empty($rows['nota1'])) {
                            $colunas = $colunas - 1;
                    ...
                    <td class="p-1 m-0 align-middle nota" style="text-align:center;"><?php echo round($media); ?></td>
                    <td class="p-1 m-0 align-middle" style="text-align:center;"<?php echo $rows['faltas']; ?></td>
                    <?php
                    echo "</tr>";
                }
                // Fim da tabela
                ...
                ?>
                <br>
                <a href="professor_visualizar_nota.php" style="color:white; font-weight: bold;" class="btn btn-danger">VOLTAR</a>
                &nbsp; &nbsp; 
                <br>
                </div>

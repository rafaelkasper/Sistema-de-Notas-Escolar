<?php
//SELECIONA DADOS PARA EXIBIR A PLANILHA DE NOTAS NÃO EDITÁVEL
...
<html>
    ...
    <body class="bg-light">
        <div class="container">
            ...
            <br>
            <br>
            <h3><b><i class="fas fa-award"></i>    CONSULTAR NOTAS</b></h3> 
            <form method="POST"action="professor_proc_visualizar_notas.php">
                <br>
                <div class="form-row">

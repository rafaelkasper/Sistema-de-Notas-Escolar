<?php
//EXIBE AS NOTAS DA TURMA COM A MÉDIA CALCULADA
...
<html>
    ...
    <body class="bg-light">
        ...
        <div class="container-fluid">
          ...
          <form  method="POST" action="professor_salvar_nota1.php">

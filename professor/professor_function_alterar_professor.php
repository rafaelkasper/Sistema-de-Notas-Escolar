<?php
//EXIBE OS DADOS PARA ALTERAR CADASTRO
...
<html>
    ...
    <body class="bg-light">
        <div class="container">
            ...
            <br>
            <br>
            <h3><i class="far fa-address-card"></i>    ALTERAR CADASTRO</h3>
            <form action="professor_function_salvar_alterar_professor.php" method="POST">

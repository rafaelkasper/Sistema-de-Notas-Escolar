<?php
//EXIBE SELEÇÃO PARA ALTERAR CADASTRO
include '../functions/valida_sessao_professor.php';
include '../functions/conecta_banco.php';
$professor_id = $_SESSION['professores_id'];
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body class="bg-light">
        <div class="container">
            ...
            <br>
            <br>
            <h3><b><i class="far fa-address-card"></i>     ALTERAR CADASTRO</b></h3> 
            <div class="container">
                <form method="POST" action="">
                    <br>
                    <p>
                        <input type="hidden" name="professor_id" value="<?php $professor_id ?>">
                ...
                <table class="table table-bordered table-hover p-0 m-0" id="pesquisar">
                    ...
                    <tbody>
                        <tr>
                            ...
                            if ($SendPesqUser) {
                                $resultado_usuario = $con->query("SELECT * FROM professores WHERE id = '$professor_id' ORDER BY nome");
                                while ($rows = $resultado_usuario->fetch_assoc()) { {
                                        ...
                                        echo "<a class='btn btn-warning' href='professor_function_alterar_professor.php?id=" . $rows['id'] . "'>Editar</a>&nbsp;&nbsp;&nbsp;" . "</td>";
                                        echo "</tr>";
                                    }
                                }
                            }

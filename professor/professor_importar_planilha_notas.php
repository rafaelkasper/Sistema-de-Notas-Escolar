<?php
//SELECIONA DADOS PARA IMPORTAR PLANILHA DE NOTAS
...
<html>
    ...
    <body class="bg-light">
        <div class="container">
            ...
            <br>
            <br>
            <h3><b>IMPORTAR PLANILHA DE NOTAS</b></h3> 
            <form method="POST"action="professor_function_importar_planilha_notas.php">
                <br>
                <div class="form-row">

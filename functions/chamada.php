...
<div id="box">
 <h1>Abaixo estÃ¡ mostrando todos os alunos do(a) <strong><?php echo $curso = base64_decode($_GET['curso']); ?></strong> Data de Hoje <strong><?php echo date("d/m/Y"); ?></strong></h1>
...
<table width="955" border="0">
  <tr>
    <td width="94"><strong>CÃ³digo:</strong></td>
    <td width="466"><strong>Nome:</strong></td>
    <td colspan="2"><strong>Este aluno estÃ¡ presente?</strong></td>
  </tr>
  <tr>
    ...
    <label for="radio">SIM 
      <input type="radio" name="presensa" value="NÃƒO">
    </label> 
    NÃƒO 
...
if($presensa == ''){
	echo "<script language='javascript'>window.alert('Por favor, informe se este aluno estÃ¡ presente ou nÃ£o na sala de aula!');</script>";
}else{
...
if(mysqli_num_rows($resultado3) == '' && $presensa == 'SIM'){
	echo "<script language='javascript'>window.alert('Este aluno nÃ£o entrou na escola hoje!');</script>";
}else{	
if(mysqli_num_rows($resultado3)>=1 && $presensa == 'NÃƒO' || $presensa == 'JUSTIFICADA'){
?>
 <td colspan="3">
 <h3><strong>Este aluno entrou na instituiÃ§Ã£o hoje, tem certeza que ele nÃ£o estÃ¡ na sala de aula?</strong></h3>

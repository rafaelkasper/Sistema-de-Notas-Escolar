        ...
        <div class="container">
            ...
            <form>
                ...
                echo "<td>" . $name[0] . "</td>";
                    ...
                    @$somar = $con->query("SELECT SUM(total) FROM horas join funcionarios on horas.func_id = funcionarios.id where horas.func_id = $func_id AND horas.ano_letivo_id = $ano_letivo");
                   @$soma = $somar->fetch_row();
                    ...
                    <a href="func_consultar_horas.php" style="color:white; font-weight: bold;" class="btn btn-danger">VOLTAR</a>

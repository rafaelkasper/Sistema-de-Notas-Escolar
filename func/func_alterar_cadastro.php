            ...
            <div class="container">
                <form method="POST" action="">
                    ...
                    <p>
                        ...
                        <input type="hidden" name="func_id" value="<?php$func_id?>">
                    ...
                    <tbody>
                        <tr>
                            ...
                            if ($SendPesqUser) {
                                ...
                                $resultado_usuario = $con->query("SELECT * FROM funcionarios WHERE id = '$func_id' ORDER BY nome");
                                while ($rows = $resultado_usuario->fetch_assoc()) { {
                                        ...
                                        echo "<td>";
                                        echo "<a class='btn btn-warning' href='func_function_alterar_func.php?id=" . $rows['id'] . "'>Editar</a>&nbsp;&nbsp;&nbsp;" . "</td>";

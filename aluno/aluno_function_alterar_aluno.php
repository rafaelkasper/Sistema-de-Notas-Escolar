<?php
//EDITA DADOS CADASTRAIS DOS ALUNOS
include '../functions/valida_sessao_aluno.php';
include '../functions/conecta_banco.php';
$id = filter_input(INPUT_GET, 'id', FILTER_SANITIZE_NUMBER_INT);
$resultado_usuario = $con->query("SELECT * FROM alunos WHERE id = '$id'");
...
<html>
    ...
    <body class="bg-light">
        ...
        <div class="container">
            ...
            <form action="aluno_function_salvar_alterar_aluno.php" method="POST">

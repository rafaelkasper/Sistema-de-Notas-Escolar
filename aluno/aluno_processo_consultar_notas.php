<?php
//EXIBE AS NOTAS DOS ALUNOS POR DISCIPLINA
...
<html>
    ...
    <body class="bg-light">
        ...
        if ($SendPesqUser) {
            ...
            $resultado = $con->query("SELECT * FROM alunos join notas on alunos.id = notas.aluno_id join turmas on notas.turmas_id = turmas.id WHERE notas.turmas_id = $turma AND notas.disciplina_id = $disciplina_id AND notas.trimestre_id = $trimestre AND notas.ano_letivo_id = $ano_letivo");
        ...
        <div class="container-fluid">
            ...
            <p class="bg-secondary text-white" style="text-align:center;"> <?php echo "TURMA " . $datas['nome_turma']; ?><br><br><?php echo $nome_discip[1]; ?></p>
            ...
            <table class="table table-bordered table-hover p-0 m-0">
                <tr class="bg-info p-0 m-0 text-white" style="font-size: 14px; text-align:center;">
                    <th>NOME</th>
                    <th>NOTA 1 <?php echo $datas['data1']; ?><br><?php echo $datas['descricao1']; ?></th>
                    <th>NOTA 2 <?php echo $datas['data2']; ?><br><?php echo $datas['descricao2']; ?></th>
                    <th>NOTA 3 <?php echo $datas['data3']; ?><br><?php echo $datas['descricao3']; ?></th>
                    <th>NOTA 4 <?php echo $datas['data4']; ?><br><?php echo $datas['descricao4']; ?></th>
                    <th>NOTA 5 <?php echo $datas['data5']; ?><br><?php echo $datas['descricao5']; ?></th>
                    <th>NOTA 6 <?php echo $datas['data6']; ?><br><?php echo $datas['descricao6']; ?></th>
                    <th>NOTA 7 <?php echo $datas['data7']; ?><br><?php echo $datas['descricao7']; ?></th>
                    <th>NOTA 8 <?php echo $datas['data8']; ?><br><?php echo $datas['descricao8']; ?></th>
                    <th>NOTA 9 <?php echo $datas['data9']; ?><br><?php echo $datas['descricao9']; ?></th>
                    <th>NOTA 10 <?php echo $datas['data10']; ?><br><?php echo $datas['descricao10']; ?></th>
                    <th>MÉDIA</th>

                </tr>

                <?php
                $result = $con->query("SELECT * FROM alunos join notas on alunos.id = notas.aluno_id join turmas on notas.turmas_id = turmas.id where notas.turmas_id = $turma AND notas.disciplina_id = $disciplina_id AND notas.trimestre_id = $trimestre AND notas.ano_letivo_id = $ano_letivo AND notas.aluno_id=$alunos_id");
                ...
                <a href="aluno_consultar_nota.php" style="color:white; font-weight: bold;" class="btn btn-danger">VOLTAR</a>
                &nbsp; &nbsp; 
